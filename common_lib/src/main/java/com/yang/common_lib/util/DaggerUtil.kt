...
fun getBaseComponent(): BaseComponent {
    ...
    return DaggerBaseComponent.builder().baseModule(BaseModule()).build()!!
}
fun getRemoteComponent(): RemoteComponent {

    return DaggerRemoteComponent.builder().baseComponent(DaggerBaseComponent.builder().baseModule(BaseModule()).build()).build()!!
}
